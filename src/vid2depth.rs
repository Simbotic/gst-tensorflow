...
// up the class data
impl ObjectSubclass for Vid2Depth {
    const NAME: &'static str = "Video2Depth";
    ...
    fn class_init(klass: &mut subclass::simple::ClassStruct<Self>) {
        ...
        klass.set_metadata(
            "Video to Depth",
            "Inference",
            "Video to depth inference TensorFlow",
...
impl ElementImpl for Vid2Depth {}

// Implementation of gst_base::BaseTransform virtual methods
impl BaseTransformImpl for Vid2Depth {
        ...
        if out_format == gst_video::VideoFormat::Bgrx {
                ...
                .zip(out_data.chunks_exact_mut(out_stride))
            {
                    ...
                    .zip(out_line[..out_line_bytes].chunks_exact_mut(4))
                {
                    ...
                    // of the pixel.
                    let gray = Vid2Depth::bgrx_to_gray(in_p, settings.shift as u8, settings.invert);
                    out_p[0] = gray;
                    out_p[1] = gray;
                    out_p[2] = gray;
                }
...
// the name "vid2depth" for being able to instantiate it via e.g.
