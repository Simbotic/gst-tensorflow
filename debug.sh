...
cargo build && gst-launch-1.0 filesrc location=assets/qr_obst.mp4 ! decodebin ! videoconvert ! videoscale ! tf_segmentation ! video/x-raw,format=RGB,width=512,height=288 ! videoconvert ! ximagesink
